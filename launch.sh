...
if ! [[ -f Create-Ultimate%20Selection%20Serverpack%20MC%201.20.1-12.2.0.zip ]]; then
    ...
    curl -Lo Create-Ultimate%20Selection%20Serverpack%20MC%201.20.1-12.2.0.zip 'https://edge.forgecdn.net/files/6626/634/Create-Ultimate%20Selection%20Serverpack%20MC%201.20.1-12.2.0.zip'
    unzip -u -o 'Create-Ultimate%20Selection%20Serverpack%20MC%201.20.1-12.2.0.zip' -d /data
